...
const CaseStudiesCarousel = () => {
  return (
    <div className="absolute top-[4964px] left-[0px] w-[1920px] h-[782px] text-left text-9xl text-gray-900 font-h1">
      <div className="absolute top-[0px] left-[0px] bg-gray-200 w-[1920px] h-[782px]" />
      <div className="absolute top-[650px] left-[660px] overflow-hidden flex flex-row items-center justify-start gap-[40px]">
      ...
      <SliderControlshover
        ...
        sliderControlshoverTop="104px"
        sliderControlshoverLeft="1503px"
      />
      <div className="absolute top-[80px] left-[345px] text-27xl leading-[130%] font-black">
